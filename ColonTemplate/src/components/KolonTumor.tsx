...
interface KolonTumorProps {
    idExtension: number;
    keyId: number;
    removeFunction: (id: number) => void;
}

interface KolonTumorState {
    open: boolean;
    annular: string;
    polypos: string;
    mucinos: string;
...
export class KolonTumor extends React.Component<KolonTumorProps, KolonTumorState> {
    private collapseDiv: React.Ref<HTMLDivElement>

    constructor(props: KolonTumorProps) {
        super(props);
        this.state = {
